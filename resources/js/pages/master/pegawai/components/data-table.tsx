                            ...
                            <td className="border text-center">
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align='end'>
                                        {gate.update && <DropdownMenuItem onClick={() => {setForm(true), setIsEdit(true), setData({ id:value.id, nip:value.nip, nama:value.nama, tte:value.tte})}}><Pencil/> Ubah</DropdownMenuItem>}
